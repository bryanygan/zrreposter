...
test('parseSince parses dates as UTC midnight', () => {
  const now = Date.parse('2026-07-10T12:00:00Z');
  assert.strictEqual(parseSince('07/07', now), Date.UTC(2026, 6, 7));
  assert.strictEqual(parseSince('2026-07-07', now), Date.UTC(2026, 6, 7));
  assert.strictEqual(parseSince('7/7/2025', now), Date.UTC(2025, 6, 7));
});
